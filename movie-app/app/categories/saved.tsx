  ...
  if (watchlist.length === 0) {
    return (
      <View style={{ flex: 1, backgroundColor: colors.backGround }}>
        <Text
          className=" font-sora text-2xl self-center "
          style={{ color: colors.secondaryText, marginTop: 86 }}
        >
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          <View className="absoulte top-0 left-0 right-0">
            ...
            <View className=" flex-row gap-2 ml-2">
              ...
              <TouchableOpacity
                onPress={toggleTheme}
                style={{ marginLeft: 273 }}
              >
                <Text
                  className=" font-sora_bold text-xl "
                  style={{ color: colors.secondaryText }}
                >
            ...
            <View>
              {watchlist.map((movie: any) => (
                <View key={movie.id} style={{ marginBottom: 20 }}>
                  ...
                  >
                    <Text
                      className="font_poppins text-lg"
                      style={{
                        backgroundColor: colors.secondaryText,
