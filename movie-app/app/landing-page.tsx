...
export default function LandingPage() {
  ...
  const handleSearch = (text: string) => {
    ...
    if (text === "") {
      ...
      const result = combinedData.filter((item: any) =>
          ...
          <ScrollView>
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    ...
                    <View className=" self-center">
                      <Text
                        className="font-sora_semi_bold text-2xl  "
                        style={{ color: colors.secondaryText }}
                      >
                        {item.name}
                      </Text>
                ...
                <Link
                  href={{
                    ...
                    params: {
                      ...
                      type:
                        info[currentIndex]?.media_type ||
                        (info[currentIndex].title ? "movie" : "tv"),
                    },
                  }}
                  asChild
                >
                  ...
                  >
                    <Text
                      className="text-center pt-4 font-sora_semi_bold rounded-lg "
                      style={{
            ...
            <View className=" mt-2 ml-2" style={{ height: 250 }}>
              ...
              {loading ? (
                ...
                <FlatList
                  data={search.length > 0 ? filterData : pop}
                  keyExtractor={(item) => item.id}
                  renderItem={({ item }) => (
                    <View>
                      <Link
            ...
            <View className=" mt-2 ml-2" style={{ height: 250 }}>
              ...
              {loading ? (
                ...
                <FlatList
                  data={search.length > 0 ? filterData : latest}
                  keyExtractor={(item) => item.id}
                  renderItem={({ item }) => (
                    <View>
                      <Link
            ...
            <View className=" mt-2 ml-2" style={{ height: 300 }}>
              ...
              {loading ? (
                ...
                <FlatList
                  data={search.length > 0 ? filterData : rate}
                  keyExtractor={(item) => item.id}
                  renderItem={({ item }) => (
                    <View>
                      <Link
